...
const TeamMember = ({ name, role, background, imageSrc, imageAlt = "Team member" }: TeamMemberProps) => {
  return (
    <Card className="overflow-hidden border-primary/10 hover:border-primary/50 transition-all duration-300" glow glowColor="rgba(0, 255, 0, 0.5)">
      <CardContent className="p-4">
        <div className="flex flex-col items-center">
          <Avatar className="h-32 w-32 mb-4 border-2 border-primary">
            <AvatarImage src={imageSrc} alt={imageAlt} className="object-cover object-center" />
